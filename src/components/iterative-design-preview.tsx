...
export default function IterativeDesignPreview({ versions, className }: IterativeDesignPreviewProps) {
    ...
    <div className={cn("space-y-8", className)}>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        <div className="space-y-6">
          ...
          <div className="p-4 bg-secondary/50 rounded-lg">
            <div className="flex justify-between items-center mb-2">
              <span className="text-sm font-medium">
                Prompt {activeVersion + 1}/{versions.length}
              </span>
              <button
            ...
            <pre className="whitespace-pre-wrap text-sm p-4 bg-background rounded overflow-auto max-h-48">
          ...
          <div className="flex justify-between">
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 border border-border rounded-md text-sm hover:bg-secondary transition-colors disabled:opacity-50 disabled:pointer-events-none"
            >
              <ArrowLeft size={14} />
              Előző változat
            </button>
        ...
        <div className="order-first lg:order-last">
          <img
            src={versions[activeVersion].image || "/images/placeholder.svg"}
        ...
        {versions.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 rounded-full ${
              activeVersion === index ? "bg-primary" : "bg-gray-300 dark:bg-gray-700"
            }`}
