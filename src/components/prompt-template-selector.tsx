...
export default function PromptTemplateSelector({ categories, className }: PromptTemplateSelectorProps) {
    ...
    <div className={cn("space-y-6", className)}>
          ...
          {getCurrentCategory()?.templates.map((template) => (
            <button
              ...
              className={`p-3 text-left border ${
                activeTemplate === template.id ? "border-primary" : "border-border"
      ...
      {activeTemplate && (
        <div className="p-4 bg-secondary/50 rounded-lg">
          ...
          <pre className="whitespace-pre-wrap text-sm p-4 bg-background rounded overflow-auto max-h-64">
