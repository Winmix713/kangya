    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <Hero
          ...
          secondaryCta={{ text: "Prompt sablonok", href: "/advanced" }}
        ...
        {/* Overview Section */}
        <Section id="overview" className="bg-background section-padding">
              ...
              <div className="interactive-panel">
                ...
                <div className="p-4">
                  <div className="flex gap-4 mb-4">
                    <button className="px-4 py-2 rounded border bg-background">Szerkesztés</button>
                    <button className="px-4 py-2 rounded border bg-background">Előnézet</button>
                    <button className="px-4 py-2 rounded border bg-background">Eredmény</button>
                  </div>
          ...
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
              <Button size="lg" asChild className="button-primary">
                <Link to="/advanced">Haladó technikák felfedezése</Link>
              </Button>
              <Button size="lg" variant="outline" asChild className="button-outline">
                <Link to="/advanced#prompt-templates">Prompt sablonok</Link>
              </Button>
            </div>
          </div>
        </Section>
