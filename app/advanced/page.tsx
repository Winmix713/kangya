...
const tutorialSteps = [
  {
    ...
    description: "Ismerkedj meg a v0 alapvető használatával és a prompt írás alapjaival.",
    code: `// Példa egy egyszerű prompt-ra
const basicPrompt = "Készíts egy bejelentkező űrlapot email címmel és jelszóval, valamint egy bejelentkezés gombbal.";

// Ezt a promptot beírhatod a v0 chat mezőjébe, és máris kapsz egy működő komponenst.`,
    language: "javascript",
  },
  {
    id: "step-2",
    title: "Részletes promptok írása",
    description: "Tanulj meg részletes promptokat írni, amelyek pontosan meghatározzák, mit szeretnél.",
    code: `// Részletes prompt példa
const detailedPrompt = \`Készíts egy bejelentkező űrlapot a következő elemekkel:
...
- Sötét módot támogató színek\`;`,
  ...
  {
    id: "step-3",
    title: "Kód exportálása és testreszabása",
    description: "Hogyan exportáld és szabd testre a generált kódot saját projektedben.",
    code: `// A generált kód exportálása után így használhatod fel egy Next.js projektben
import { LoginForm } from '@/components/login-form';

export default function LoginPage() {
  const handleLogin = async (data) => {
    // Itt kezelheted a bejelentkezési adatokat
    console.log('Bejelentkezési adatok:', data);
    // API hívás, autentikáció, stb.
  };
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main>
        {/* Hero Section */}
        <Section
          className="bg-gradient-to-b from-gray-50 to-white dark:from-gray-900 dark:to-gray-950 py-24 pt-32"
          fullWidth
        >
        ...
        <Section className="bg-white dark:bg-gray-950">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <FeatureCard
              ...
              description="Tanulj meg lépésről lépésre fejleszteni a promptjaidat a legjobb eredmény érdekében."
              icon={<Lightbulb />}
              href="#iterative-design"
            />
            <FeatureCard
              title="Prompt sablonok"
              description="Használj előre elkészített sablonokat a gyakori komponensek gyors létrehozásához."
              icon={<Code />}
              href="#prompt-templates"
            />
            <FeatureCard
              title="Kód exportálás"
              description="Exportáld és használd fel a generált kódot saját projektedben."
              icon={<Wand2 />}
              href="#code-export"
            />
            <FeatureCard
              title="Interaktív útmutató"
              description="Lépésről lépésre haladj végig a v0 használatának alapjain."
              icon={<Sparkles />}
              href="#interactive-tutorial"
            />
          </div>
        </Section>
        ...
        <Section
          ...
          title="Interaktív útmutató"
          subtitle="Lépésről lépésre haladj végig a v0 használatának alapjain."
          className="bg-white dark:bg-gray-950"
        >
          <InteractiveTutorial steps={tutorialSteps} className="max-w-3xl mx-auto" />
        </Section>

        {/* Command Examples Section */}
        <Section
          id="command-examples"
          title="Hasznos parancsok"
          subtitle="Gyakran használt parancsok a v0 használatához"
          className="bg-gray-50 dark:bg-gray-900"
        >
          <div className="max-w-3xl mx-auto space-y-6">
            <CommandExample
              command="npx create-next-app@latest my-v0-project --use-npm"
              description="Új Next.js projekt létrehozása npm használatával"
            />
            <CommandExample command="npm install @vercel/v0" description="A v0 csomag telepítése meglévő projektbe" />
            <CommandExample command="npm run dev" description="Fejlesztői szerver indítása" />
            <CommandExample
              command="npm run build && npm run start"
              description="Projekt build-elése és éles környezetben való indítása"
            />
          </div>
        </Section>
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <div className="glass-panel p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">
                A leghatékonyabb promptok részletesek, specifikusak és tartalmazzák az elvárt eredmény pontos leírását.
                Érdemes a promptot lépésenként fejleszteni, először egy alapverzióval kezdeni, majd azt fokozatosan
                bővíteni.
              </p>
            </div>
            ...
            <div className="glass-panel p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">
                A generált kódot a kód panel jobb felső sarkában található "Export" gombra kattintva töltheted le.
                Választhatsz teljes projekt vagy csak egy komponens exportálása között.
              </p>
            </div>
            ...
            <div className="glass-panel p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">
                Igen, a generált kód teljesen testreszabható. A kódot saját projektedbe másolhatod és módosíthatod a
                saját igényeidnek megfelelően. A komponensek modern React és Tailwind CSS technológiákkal készülnek.
              </p>
            </div>
            ...
            <div className="glass-panel p-6 rounded-lg">
              ...
              <p className="text-muted-foreground">
                A winmix.hu szolgáltatásait a felhasználási feltételeknek megfelelően használhatod. A generált kód a
                sajátod, felhasználhatod kereskedelmi projektekben is.
              </p>
            </div>
          </div>
        </Section>
