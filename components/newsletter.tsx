...
export default function Newsletter({
  ...
  return (
    <div className={cn("p-6 bg-gray-50 dark:bg-gray-900 rounded-lg", className)}>
      {!isSubmitted ? (
        <>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <input
                ...
                className="w-full p-3 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-950"
                disabled={isLoading}
              />
